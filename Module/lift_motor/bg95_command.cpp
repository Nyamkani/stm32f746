...
void BG95::HardwareParamEnqueue()
{
	...
	AsyncWriteDataEnqueue(DEV_Cmd, 0, CMD_Continue);      //DeviceCommand - Continues the movement after quick-stop or halt

	AsyncWriteDataEnqueue(DEV_Mode, 0, MODE_OFF);      //Device Mode -  Off
}
...
void BG95::ClearParamCommand(){AsyncWriteDataEnqueue(DEV_Cmd, 0, CMD_ClearParam);}
