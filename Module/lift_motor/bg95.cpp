...
void BG95::DataProcess(int index, int subindex, int data)
{
	switch(index)
	{
		...
		case 0x3a04:
			if(subindex == 1) this->pos_mode_vel_ = data ;
			break;
		case 0x3500: this->vel_mode_vel_ = data; break;

		case 0x3911: this->motor_dir_= data; break;


		//setting parameters
		case 0x3300: this->actual_vel_ = data; break;
