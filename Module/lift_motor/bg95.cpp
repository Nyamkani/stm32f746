...
{
	if(TransmitReceiveResponse() == HAL_ERROR)
	{
		this->comm_status_ = false;		//not received
	}
	else
	{
		this->comm_status_ = true;		//Successfully received or timeouts
	}
}
...
void BG95::DataAnalysis()
{
	...
	//2.check command byte is matched(sdo)
